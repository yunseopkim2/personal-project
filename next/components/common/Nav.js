    ...
    useEffect(() => {
      console.log(' 모듈에 저장된 로그인값: '+JSON.stringify(loginUser))
        if (loginUser === null) {
            ...
            setImageInfos({
                imageUrl: 'https://e7.pngegg.com/pngimages/799/987/png-clipart-computer-icons-avatar-icon-design-avatar-heroes-computer-wallpaper.png' +
                        '8x8ORLeG25en.jpg',
                imageTitle: 'sign'
            })
        } else {
